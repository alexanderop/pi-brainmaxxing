...
**Inputs:** brain snapshot, AGENTS.md path.
...
- Flag notes as:
  ...
  - **Low-value**: Fails the test: "Would the agent reliably get this wrong without this note, AND does it come up often or cause real damage?" If not both, flag it.
...
- **Audit AGENTS.md**: Flag sections that are outdated, redundant with brain notes or skill instructions, or could be condensed. Check that instructions match actual project structure.
- Produce a report with brain and AGENTS.md findings separated. Each item: what's flagged, why, and suggested action (update, merge, condense, or delete).
